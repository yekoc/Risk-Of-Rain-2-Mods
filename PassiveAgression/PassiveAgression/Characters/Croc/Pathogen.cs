...
namespace PassiveAgression.Croc
{
    public static class PathogenSpecial{
     ...
     static PathogenSpecial(){
         ...
         LanguageAPI.Add("PASSIVEAGRESSION_CROCSPREAD_DESC","Release a disease that deals <style=cIsDamage>85% damage</style>. The disease spreads to up to <style=cIsDamage>20</style> targets, <style=cIsUtility>carrying a random debuff from its last host</style>.");
