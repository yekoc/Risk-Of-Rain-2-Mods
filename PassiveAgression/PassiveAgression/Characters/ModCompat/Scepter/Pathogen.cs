...
namespace PassiveAgression.Croc
{
    public static class PathogenSpecialScepter{
     ...
     static PathogenSpecialScepter(){
         ...
         def.baseRechargeInterval = PathogenSpecial.def.baseRechargeInterval;
         def.canceledFromSprinting = false;
         def.cancelSprintingOnActivation = false;
         def.activationStateMachineName = "Mouth";
         def.activationState = new SerializableEntityStateType(typeof(PathogenSpecial.PathogenState));
